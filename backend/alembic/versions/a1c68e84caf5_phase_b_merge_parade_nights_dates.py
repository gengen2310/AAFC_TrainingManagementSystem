...
def downgrade():
    ...
    with op.batch_alter_table("parade_nights") as batch:
        ...
        # (175e1c6e12f7) later failed on DROP INDEX ix_parade_nights_training_year
        # and the chain could not be walked past this point. Found by
        # scripts/rehearse_migrations.py; downgrade-only, upgrade untouched.
        batch.create_index("ix_parade_nights_training_year", ["training_year"], unique=False)
        batch.drop_column("planning_year_id")
