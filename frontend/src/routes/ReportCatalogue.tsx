...
const ROWS: Row[] = [
  ...
  { name: "Program coverage (squadron/wing)", backend: "yes", frontend: "yes", priority: "should", value: "Cadet Program core vs extension", role: "Squadron+" },
  { name: "Learning Hub missing-link report", backend: "yes", frontend: "yes", priority: "should", value: "Find items with no LH link", role: "Squadron+" },
  { name: "Cancelled / rescheduled trend", backend: "partial", frontend: "no", priority: "should", value: "Repeat-cancellation pattern", role: "Wing+" },
  { name: "Cross-squadron not-delivered", backend: "no", frontend: "no", priority: "should", value: "Wide delivery gaps", role: "Wing+" },
  { name: "Phase coverage heatmap", backend: "no", frontend: "no", priority: "later", value: "Visual phase gaps", role: "Wing+" },
