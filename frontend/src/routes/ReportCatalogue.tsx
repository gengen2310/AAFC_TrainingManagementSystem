...
const ROWS: Row[] = [
  ...
  { name: "Cross-squadron not-delivered",  backend: "yes",     frontend: "yes", priority: "should", value: "Wing-wide delivery gaps (Wing Overview page, shows when data exists)", role: "Wing+" },
  { name: "Cancelled / rescheduled trend", backend: "yes",     frontend: "yes", priority: "should", value: "Repeat-cancellation pattern (Wing Overview page, shows when data exists)", role: "Wing+" },
