...
**Completion rate** (CLOSED + STAGING VERIFIED + FIXED LOCALLY) **= 111 / 138 = 80%**

> Counts are from rows matching `^\| [A-Z]+-[0-9]` in this file. Excludes cross-reference summary rows (numbered `1–25`) and GAP-prefixed decision rows (GAP-03, GAP-05, GAP-20, GAP-22, GAP-23) which duplicate existing HG-/SEC- items. Prior totals of 147–148 were inflated by counting those summary rows.
