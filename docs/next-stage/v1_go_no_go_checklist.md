...
commit `fd55d66` (2026-08-14). The items below are the **human-action gates** that
...
- ☐ Developer on-call has confirmed: test suite passes (1689+ tests), staging deploy is current, no known regressions
